...
template<class T>
NodoAVL<T>* ArbolAVL::giroDerecha(NodoAVL<T>* &n2){
...
template<class T>
NodoAVL<T>* ArbolAVL::giroDerechaIzquierda(NodoAVL<T>* &n1){
    NodoAVL<T>* n_padre;
...
template<class T>
NodoAVL<T>* ArbolAVL::giroIzquierda(NodoAVL<T>* &n1){
...
template<class T>
NodoAVL<T>* ArbolAVL::giroIzquierdaDerecha(NodoAVL<T>* &n1){
    NodoAVL<T>* n_padre;
